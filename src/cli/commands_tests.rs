...
fn request_model_matches_plain_and_prefixed_and_pinned() {
    ...
    assert!(request_model_matches("deepseek-v4-flash", "deepseek-v4-flash"));
    // A route prefix on the request is consumed; the applied id is bare.
    assert!(request_model_matches("claude-api:claude-fable-5", "claude-fable-5"));
...
fn request_model_matches_rejects_a_different_model() {
    ...
    assert!(!request_model_matches("deepseek-v4-flash", "claude-opus-4-6"));
    assert!(!request_model_matches("claude-api:claude-fable-5", "claude-opus-4-6"));
}
